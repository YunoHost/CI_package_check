...
git clone https://github.com/YunoHost/package_check "$script_dir/package_check" ../package_check
sudo sed -i "s/DISTRIB=.*/DISTRIB=stretch/" "$script_dir/package_check/config"
