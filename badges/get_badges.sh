...
wget -nv https://img.shields.io/badge/Integration-Level_2-orange.svg      -O "$script_dir/level2.svg"
wget -nv https://img.shields.io/badge/Integration-Level_3-yellow.svg      -O "$script_dir/level3.svg"
wget -nv https://img.shields.io/badge/Integration-Level_4-yellow.svg      -O "$script_dir/level4.svg"
wget -nv https://img.shields.io/badge/Integration-Level_5-yellowgreen.svg -O "$script_dir/level5.svg"
wget -nv https://img.shields.io/badge/Integration-Level_6-green.svg       -O "$script_dir/level6.svg"
wget -nv https://img.shields.io/badge/Integration-Level_7-green.svg       -O "$script_dir/level7.svg"
wget -nv https://img.shields.io/badge/Integration-Level_8-brightgreen.svg -O "$script_dir/level8.svg"
