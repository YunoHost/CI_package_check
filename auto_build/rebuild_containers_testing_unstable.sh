...
do
	...
	sudo echo "deb http://forge.yunohost.org/debian/ stretch stable $source" | sudo tee /var/lib/lxcsnaps/pcheck_$change_version/snap0/rootfs/etc/apt/sources.list.d/yunohost.list
